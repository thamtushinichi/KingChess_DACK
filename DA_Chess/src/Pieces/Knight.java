...
public class Knight {
	...
	public Knight(String pathName_Icon,int startX,int startY)
	{
		point = new Point();
		pointOld= new Point();
	...
	{
		if((x+1 ==this.x) && (y+2 == this.y) ||(x+1==this.x) && (y-2==this.y) || (x-1==this.x) && (y+2==this.y)
				|| (x-1==this.x) && (y-2==this.y)|| (x+2==this.x)&& (y+1==this.y)
				|| (x+2==this.x)&&(y-1==this.y)||(x-2==this.x)&&(y+1==this.y)||(x-2==this.x)&&(y-1==this.y))
		{
			return true;
		}
		else
