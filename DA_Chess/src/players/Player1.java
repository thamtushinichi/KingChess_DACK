...
public class Player1 {
	...
	private int piece_Is_Killed_To_Protect_King; // là quân cờ đối phương phải bị tiêu diệt nếu muốn bảo vệ vua đang bị quân cờ này chiếu
	...
	public void changePositionToOld(Point newPoint,int i) {
        switch(i) {
            ...
            case 17:wr1.toPointOld(newPoint);break;
            case 18:wr2.toPointOld(newPoint);break;
            case 19:wn1.toPointOld(newPoint);break;
            case 20:wn2.toPointOld(newPoint);break;
            case 21: wb1.toPointOld(newPoint);break;
            case 22: wb2.toPointOld(newPoint);break;
            case 23: wq.toPointOld(newPoint);break;
            case 24: wk.toPointOld(newPoint);break;
            case 25:  wPawns[0].toPointOld(newPoint);break;
            case 26:  wPawns[1].toPointOld(newPoint);break;
            case 27:  wPawns[2].toPointOld(newPoint);break;
            case 28:  wPawns[3].toPointOld(newPoint);break;
            case 29:  wPawns[4].toPointOld(newPoint);break;
            case 30:  wPawns[5].toPointOld(newPoint);break;
            case 31:  wPawns[6].toPointOld(newPoint);break;
            case 32:  wPawns[7].toPointOld(newPoint);break;
        }
    }
	public void changePixel(int newPixelX,int newPixelY,int i) {
        ...
        switch(choosenOne) {
            ...
            case 17:wr1.setPixelPoint(newPixelX,newPixelY);break;
            case 18:wr2.setPixelPoint(newPixelX,newPixelY);break;
            case 19:wn1.setPixelPoint(newPixelX,newPixelY);break;
            case 20:wn2.setPixelPoint(newPixelX,newPixelY);break;
            case 21: wb1.setPixelPoint(newPixelX,newPixelY);break;
            case 22: wb2.setPixelPoint(newPixelX,newPixelY);break;
            case 23: wq.setPixelPoint(newPixelX,newPixelY);break;
            case 24: wk.setPixelPoint(newPixelX,newPixelY);break;
            case 25:  wPawns[0].setPixelPoint(newPixelX,newPixelY);break;
            case 26:  wPawns[1].setPixelPoint(newPixelX,newPixelY);break;
            case 27:  wPawns[2].setPixelPoint(newPixelX,newPixelY);break;
            case 28:  wPawns[3].setPixelPoint(newPixelX,newPixelY);break;
            case 29:  wPawns[4].setPixelPoint(newPixelX,newPixelY);break;
            case 30:  wPawns[5].setPixelPoint(newPixelX,newPixelY);break;
            case 31:  wPawns[6].setPixelPoint(newPixelX,newPixelY);break;
            case 32:  wPawns[7].setPixelPoint(newPixelX,newPixelY);break;
        }
    }
	public Point getPixelPoint(int i) {
        ...
        switch(choosenOne) {
            ...
            case 17:return wr1.getPixelPoint();
            case 18:return wr2.getPixelPoint();
            case 19:return wn1.getPixelPoint();
            case 20:return wn2.getPixelPoint();
            case 21: return wb1.getPixelPoint();
            case 22: return wb2.getPixelPoint();
            case 23: return wq.getPixelPoint();
            case 24: return wk.getPixelPoint();
            case 25: return  wPawns[0].getPixelPoint();
            case 26:  return wPawns[1].getPixelPoint();
            case 27: return  wPawns[2].getPixelPoint();
            case 28:  return wPawns[3].getPixelPoint();
            case 29: return  wPawns[4].getPixelPoint();
            case 30: return wPawns[5].getPixelPoint();
            case 31: return wPawns[6].getPixelPoint();
            case 32: return wPawns[7].getPixelPoint();
        }
        return null;
    }
	public boolean checkMove(Point newP,int i)
	{
		 choosenOne=i;
	        switch(choosenOne) {
	            ...
	            case 17:return wr1.canMove(newP.x,newP.y);
	            case 18:return wr2.canMove(newP.x,newP.y);
	            case 19:return wn1.canMove(newP.x,newP.y);
	            case 20:return wn2.canMove(newP.x,newP.y);
	            case 21: return wb1.canMove(newP.x,newP.y);
	            case 22: return wb2.canMove(newP.x,newP.y);
	            case 23: return wq.canMove(newP.x,newP.y);
	            case 24: return wk.canMove(newP.x,newP.y);
	            case 25: return  wPawns[0].canMove(newP.x,newP.y,Color);
	            case 26:  return wPawns[1].canMove(newP.x,newP.y,Color);
	            case 27: return  wPawns[2].canMove(newP.x,newP.y,Color);
	            case 28:  return wPawns[3].canMove(newP.x,newP.y,Color);
	            case 29: return  wPawns[4].canMove(newP.x,newP.y,Color);
	            case 30: return wPawns[5].canMove(newP.x,newP.y,Color) ;
	            case 31: return wPawns[6].canMove(newP.x,newP.y,Color);
	            case 32: return wPawns[7].canMove(newP.x,newP.y,Color);
	        }
	        return false;
	}
	public boolean setSeentoPawns(int i,Point P) {
        switch(i) {
            case 25:   return  wPawns[0].setSeenByCheckKing(P,"white");
            case 26:   return wPawns[1].setSeenByCheckKing(P,"white");
            case 27:  return   wPawns[2].setSeenByCheckKing(P,"white");
            case 28:  return    wPawns[3].setSeenByCheckKing(P,"white");
            case 29:  return  wPawns[4].setSeenByCheckKing(P,"white");
            case 30:  return  wPawns[5].setSeenByCheckKing(P,"white");
            case 31:  return  wPawns[6].setSeenByCheckKing(P,"white");
            case 32: return wPawns[7].setSeenByCheckKing(P,"white");
        }
        return false;
    }
    public boolean returnsoliderSeen(int i) {
        switch(i) {
            case 25:   return  wPawns[0].isMySeen();
            case 26:   return wPawns[1].isMySeen();
            case 27:  return   wPawns[2].isMySeen();
            case 28:  return    wPawns[3].isMySeen();
            case 29:  return  wPawns[4].isMySeen();
            case 30:  return  wPawns[5].isMySeen();
            case 31:  return  wPawns[6].isMySeen();
            case 32: return wPawns[7].isMySeen();
        }
        return false;
    }
    public boolean checkWay(Point newP,Point postionFromOthers,int i) {
        switch(i) {
            case 17:return wr1.isPieceInMyWay(newP.x,newP.y,postionFromOthers);
            case 18:return wr2.isPieceInMyWay(newP.x,newP.y,postionFromOthers);
            case 21: return wb1.isPieceInMyWay(newP.x,newP.y,postionFromOthers);
            case 22: return wb2.isPieceInMyWay(newP.x,newP.y,postionFromOthers);
            case 23: return wq.isPieceInMyWay(newP.x,newP.y,postionFromOthers);
            case 25: return  wPawns[0].isPieceInMyWay(newP.x,newP.y,postionFromOthers,Color);
            case 26:  return wPawns[1].isPieceInMyWay(newP.x,newP.y,postionFromOthers,Color);
            case 27: return  wPawns[2].isPieceInMyWay(newP.x,newP.y,postionFromOthers,Color);
            case 28:  return wPawns[3].isPieceInMyWay(newP.x,newP.y,postionFromOthers,Color);
            case 29: return  wPawns[4].isPieceInMyWay(newP.x,newP.y,postionFromOthers,Color);
            case 30: return wPawns[5].isPieceInMyWay(newP.x,newP.y,postionFromOthers,Color);
            case 31: return wPawns[6].isPieceInMyWay(newP.x,newP.y,postionFromOthers,Color);
            case 32: return wPawns[7].isPieceInMyWay(newP.x,newP.y,postionFromOthers,Color);
    ...
    public boolean killedPiece(int i) {
        ...
        switch(i) {
            ...
            case 17:  wr1.setPoint(out);return true;
            case 18:   wr2.setPoint(out);return true;
            case 19:  wn1.setPoint(out);return true;
            case 20:  wn2.setPoint(out);return true;
            case 21:   wb1.setPoint(out);return true;
            case 22:   wb2.setPoint(out);return true;
            case 23:   wq.setPoint(out);return true;
            case 24:    return false;
            case 25:    wPawns[0].setPoint(out);return true;
            case 26:   wPawns[1].setPoint(out);return true;
            case 27:   wPawns[2].setPoint(out);return true;
            case 28:    wPawns[3].setPoint(out);return true;
            case 29:    wPawns[4].setPoint(out);return true;
            case 30:   wPawns[5].setPoint(out);return true;
            case 31:   wPawns[6].setPoint(out);return true;
            case 32:   wPawns[7].setPoint(out);return true;
        }
    ...
    public boolean checkKing(Point p1,Point p2,int i) {
        switch(i) {
            case 17:return  wr1.checkKing(p1.x,p1.y,p2);
            case 18:return wr2.checkKing(p1.x,p1.y,p2);
            case 19:return  wn1.canMove(p1.x,p1.y);
            case 20:return  wn2.canMove(p1.x,p1.y);
            case 21:return   wb1.checkKing(p1.x,p1.y,p2);
            case 22:return   wb2.checkKing(p1.x,p1.y,p2);
            case 23:return   wq.checkKing(p1.x,p1.y,p2);
            
            case 25:return    wPawns[0].canMove(p1.x,p1.y,Color);
            case 26:return   wPawns[1].canMove(p1.x,p1.y,Color);
            case 27:return   wPawns[2].canMove(p1.x,p1.y,Color);
            case 28:return    wPawns[3].canMove(p1.x,p1.y,Color);
            case 29:return    wPawns[4].canMove(p1.x,p1.y,Color);
            case 30: return  wPawns[5].canMove(p1.x,p1.y,Color);
            case 31:return   wPawns[6].canMove(p1.x,p1.y,Color);
            case 32:return   wPawns[7].canMove(p1.x,p1.y,Color);
        }
        return false;
    }
	...
	public boolean checkWayToPosition(Player2 enemy, Point newP)
	{
	 ...
	 public String Tell_me_About_last_move() {
	        switch(inHand) {
	            ...
	            case 17:return wr1.tell_me();
	            case 18:return wr2.tell_me();
	            case 19:return wn1.tell_me();
	            case 20:return wn2.tell_me();
	            case 21:return wb1.tell_me();
	            case 22:return wb2.tell_me();
	            case 23:return wq.tell_me();
	            case 24:return wk.tell_me();
	            case 25:return  wPawns[0].tell_me();
	            case 26:return  wPawns[1].tell_me();
	            case 27:return  wPawns[2].tell_me();
	            case 28:return  wPawns[3].tell_me();
	            case 29:return  wPawns[4].tell_me();
	            case 30:return  wPawns[5].tell_me();
	            case 31:return  wPawns[6].tell_me();
	            case 32:return  wPawns[7].tell_me();
	        }
	        return null;
	    }
}
